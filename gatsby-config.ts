...
const config: GatsbyConfig = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        name: `nickngn-blog - @lekoarts/gatsby-theme-minimal-blog`,
        short_name: `nickngn-blog`,
        description: `Where I note down my knowledge and thoughts while working`,
        start_url: `/`,
